...
\begin{document}
	...
	\section{Anwendung}
		...
		\subsection{Bipolare Technik}
			...
			\begin{figure}[ht] 
				\centering
				\includegraphics[width=0.5\columnwidth]{images/_bipolareTechnik.png}
				\caption{		 
		...
		\subsection{Monopolare Technik}
			...
			Außerhalb des Wechselwirkungvolumens fächern sich die E-Feldlinien derart auf, dass die Stromdichte unkritisch ist. Dieser Sachverhalt wird in Abbildung \ref{fig:monopolareTechnik2} deutlich. Wichtig ist hierbei die gewissenhafte Aufbringung der Gegenelektrode. Es darf des weiteren keine Berührung durch dritte Personen während der Behandlung auftreten.
			\begin{figure}[ht] 
				\centering
				\includegraphics[width=0.5\columnwidth]{images/_monopolareTechnik.png}
				\caption{		 
			...
			\begin{figure}[ht] 
				\centering
				\includegraphics[width=0.5\columnwidth]{images/monoterminaleTechnik.png}
				\caption{		 
